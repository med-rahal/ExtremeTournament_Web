...
final class Version20220414215401 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE produit (ref_prod INT AUTO_INCREMENT NOT NULL, nom_prod VARCHAR(50) NOT NULL, prix DOUBLE PRECISION NOT NULL, total_en_stock INT NOT NULL, descriptif VARCHAR(50) NOT NULL, categorie_prod VARCHAR(50) NOT NULL, disponibilite VARCHAR(50) NOT NULL, INDEX IDX_29A5EC272FBB81F (id_panier), PRIMARY KEY(ref_prod)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE commentaire ADD C   ONSTRAINT FK_67F068BCB72EAA8E FOREIGN KEY (id_publication) REFERENCES publication (id_publication)');
