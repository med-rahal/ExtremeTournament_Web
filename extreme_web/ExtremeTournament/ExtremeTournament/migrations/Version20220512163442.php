 ...
 */
final class Version20220512163442 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE matchs (id_match INT AUTO_INCREMENT NOT NULL, poule VARCHAR(255) NOT NULL, nom_equipe_a VARCHAR(50) NOT NULL, nom_equipe_b VARCHAR(50) NOT NULL, date_match DATE NOT NULL, emplacement VARCHAR(50) NOT NULL, INDEX IDX_6B1E6041FA1FEB40 (poule), PRIMARY KEY(id_match)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE panier (id_panier INT AUTO_INCREMENT NOT NULL, id_user INT DEFAULT NULL, quantite INT NOT NULL, total_panier DOUBLE PRECISION NOT NULL, ref_prod INT NOT NULL, INDEX IDX_24CC0DF26B3CA4B (id_user), INDEX IDX_24CC0DF29C1263CD (ref_prod), PRIMARY KEY(id_panier)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE poule (nom_poule VARCHAR(255) NOT NULL, idT INT NOT NULL, INDEX IDX_FA1FEB40D5D012F3 (idT), PRIMARY KEY(nom_poule)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE produit (ref_prod INT AUTO_INCREMENT NOT NULL, nom_prod VARCHAR(50) NOT NULL, prix DOUBLE PRECISION NOT NULL, total_en_stock INT NOT NULL, descriptif VARCHAR(100) NOT NULL, categorie_prod VARCHAR(50) NOT NULL, disponibilite VARCHAR(50) NOT NULL, image VARCHAR(50) NOT NULL, PRIMARY KEY(ref_prod)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE tournoi (id_t INT AUTO_INCREMENT NOT NULL, nom_t VARCHAR(255) NOT NULL, emplacement_t VARCHAR(255) NOT NULL, date_t DATE NOT NULL, UNIQUE INDEX UNIQ_18AFD9DFA92175A9 (nom_t), PRIMARY KEY(id_t)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id_user INT AUTO_INCREMENT NOT NULL, nom VARCHAR(50) NOT NULL, prenom VARCHAR(50) NOT NULL, username VARCHAR(50) NOT NULL, date_naissance DATE NOT NULL, sexe VARCHAR(30) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', email VARCHAR(50) NOT NULL, passw VARCHAR(255) NOT NULL, tel VARCHAR(30) NOT NULL, adresse VARCHAR(50) NOT NULL, image VARCHAR(255) NOT NULL, banned TINYINT(1) NOT NULL, github_id VARCHAR(255) DEFAULT NULL, reset_token VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id_user)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE membre DROP FOREIGN KEY FK_F6B4FB29737800BA');
