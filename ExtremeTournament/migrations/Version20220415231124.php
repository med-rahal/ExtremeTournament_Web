 ...
 */
final class Version20220415231124 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE panier (id_panier INT AUTO_INCREMENT NOT NULL, id_user INT NOT NULL, quantite INT NOT NULL, total_panier DOUBLE PRECISION NOT NULL, refProd INT NOT NULL, INDEX IDX_24CC0DF26B3CA4B (id_user), INDEX IDX_24CC0DF29C1263CD (refProd), PRIMARY KEY(id_panier)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE panier ADD CONSTRAINT FK_24CC0DF29C1263CD FOREIGN KEY (refProd) REFERENCES produit (refProd)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE panier DROP FOREIGN KEY FK_24CC0DF29C1263CD');
